...
export var Input = function (props) {
    ...
    var classnames = classNames('ant-input-wrapper', (_a = {},
    ...
    return (React.createElement("div", { className: classnames, style: style },
        prepend && React.createElement("div", { className: "ant-input-group-prepend" }, prepend),
        icon && React.createElement("div", { className: "icon-wrapper" },
            React.createElement(Icon, { icon: icon, title: "title-" + icon })),
        React.createElement("input", __assign({ className: "ant-input-inner", disabled: disabled }, restProps)),
        append && React.createElement("div", { className: "ant-input-group-append" }, append)));
};
