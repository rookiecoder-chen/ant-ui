...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "ant-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "ant-upload-list-item", key: item.uid },
